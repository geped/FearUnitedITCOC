...
const CARD_EVENT_CATALOG = [
  ...
  card('elx_archer', 'elixir', 'Archer', 'Arciere'),
  card('elx_giant', 'elixir', 'Giant', 'Gigante'),
  card('elx_goblin', 'elixir', 'Goblin', 'Goblin'),
  card('elx_wall_breaker', 'elixir', 'Wall Breaker', 'Spaccamuro'),
  card('elx_balloon', 'elixir', 'Balloon', 'Mongolfiera'),
  card('elx_wizard', 'elixir', 'Wizard', 'Stregone'),
  card('elx_healer', 'elixir', 'Healer', 'Guaritore'),
  card('elx_dragon', 'elixir', 'Dragon', 'Drago'),
  card('elx_pekka', 'elixir', 'P.E.K.K.A', 'P.E.K.K.A'),
  card('elx_baby_dragon', 'elixir', 'Baby Dragon', 'Cucciolo di Drago'),
  ...
  card('elx_dragon_rider', 'elixir', 'Dragon Rider', 'Cavalcadraghi'),
  card('elx_electro_titan', 'elixir', 'Electro Titan', 'Titana delle Folgori'),
  card('elx_root_rider', 'elixir', 'Root Rider', 'Guardiana delle Selve'),
  ...
  card('dke_minion', 'dark_elixir', 'Minion', 'Sgherro', { wikiaKey: 'minion' }),
  card('dke_hog_rider', 'dark_elixir', 'Hog Rider', 'Domatore di Cinghiali', { wikiaKey: 'hog_rider' }),
  ...
  card('dke_lava_hound', 'dark_elixir', 'Lava Hound', 'Mastino Lavico', { wikiaKey: 'lava_hound' }),
  ...
  card('dke_apprentice_warden', 'dark_elixir', 'Apprentice Warden', 'Apprendista Sorvegliante'),
  ...
  card('bb_sneaky_archer', 'builder_base', 'Sneaky Archer', 'Arciere Furtivo'),
  ...
  card('bb_baby_dragon', 'builder_base', 'Baby Dragon', 'Cucciolo di Drago'),
  card('bb_cannon_cart', 'builder_base', 'Cannon Cart', 'Cannone a Rotelle'),
  ...
  card('bb_super_pekka', 'builder_base', 'Power P.E.K.K.A', 'P.E.K.K.A Micidiale', { wikiaKey: 'power_pekka' }),
  card('bb_hog_glider', 'builder_base', 'Hog Glider', 'Domatore Volante'),

  // ── Super Truppe (17) ──────────────────────────────────────────────────
  card('st_super_barbarian', 'super_troop', 'Super Barbarian', 'Superbarbaro', { wikiaKey: 'super_barbarian' }),
  card('st_super_archer', 'super_troop', 'Super Archer', 'Superarciere', { wikiaKey: 'super_archer' }),
  card('st_super_giant', 'super_troop', 'Super Giant', 'Supergigante', { wikiaKey: 'super_giant' }),
  card('st_sneaky_goblin', 'super_troop', 'Sneaky Goblin', 'Goblin Furtivo', { wikiaKey: 'sneaky_goblin' }),
  card('st_super_wall_breaker', 'super_troop', 'Super Wall Breaker', 'Superspaccamuro', { wikiaKey: 'super_wall_breaker' }),
  card('st_rocket_balloon', 'super_troop', 'Rocket Balloon', 'Mongolfiera Razzo', { wikiaKey: 'rocket_balloon' }),
  card('st_super_wizard', 'super_troop', 'Super Wizard', 'Superstregone'),
  card('st_super_dragon', 'super_troop', 'Super Dragon', 'Superdrago'),
  card('st_inferno_dragon', 'super_troop', 'Inferno Dragon', 'Drago Infernale', { wikiaKey: 'inferno_dragon' }),
  card('st_super_miner', 'super_troop', 'Super Miner', 'Superminatore'),
  card('st_super_yeti', 'super_troop', 'Super Yeti', 'Super Yeti', { wikiaKey: 'super_yeti' }),
  card('st_super_minion', 'super_troop', 'Super Minion', 'Supersgherro'),
  card('st_super_hog_rider', 'super_troop', 'Super Hog Rider', 'Superdomatore di Cinghiali'),
  card('st_super_valkyrie', 'super_troop', 'Super Valkyrie', 'Supervalchiria', { wikiaKey: 'super_valkyrie' }),
  card('st_super_witch', 'super_troop', 'Super Witch', 'Superstrega', { wikiaKey: 'super_witch' }),
  card('st_ice_hound', 'super_troop', 'Ice Hound', 'Mastino Glaciale'),
  card('st_super_bowler', 'super_troop', 'Super Bowler', 'Superbocciatore'),
];
