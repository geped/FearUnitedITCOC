...
REVOKE ALL ON FUNCTION public.cocboard_upsert_global_chat_subscriber(bigint, text, text, bigint, timestamptz, boolean, timestamptz, bigint, bigint, boolean) FROM PUBLIC;
...
GRANT EXECUTE ON FUNCTION public.cocboard_upsert_global_chat_subscriber(bigint, text, text, bigint, timestamptz, boolean, timestamptz, bigint, bigint, boolean) TO service_role;
